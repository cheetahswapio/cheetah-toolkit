...
it("renders correctly", () => {
  ...
  expect(asFragment()).toMatchInlineSnapshot(`
    ...
    .c3:hover:not(:disabled):not(.cheetah-button--disabled):not(.cheetah-button--disabled):not(:active) {
      opacity: 0.65;
    }

    .c3:active:not(:disabled):not(.cheetah-button--disabled):not(.cheetah-button--disabled) {
      opacity: 0.85;
    }

    .c3:disabled,
    .c3.cheetah-button--disabled {
    ...
    .c8:hover:not(:disabled):not(.cheetah-button--disabled):not(.cheetah-button--disabled):not(:active) {
      opacity: 0.65;
    }

    .c8:active:not(:disabled):not(.cheetah-button--disabled):not(.cheetah-button--disabled) {
      opacity: 0.85;
    }

    .c8:disabled,
    .c8.cheetah-button--disabled {
      background-color: #E9EAEB;
      border-color: #E9EAEB;
      box-shadow: none;
      color: #BDC2C4;
    ...
    .c24:hover:not(:disabled):not(.cheetah-button--disabled):not(.cheetah-button--disabled):not(:active) {
      opacity: 0.65;
    }

    .c24:active:not(:disabled):not(.cheetah-button--disabled):not(.cheetah-button--disabled) {
      opacity: 0.85;
    }

    .c24:disabled,
    .c24.cheetah-button--disabled {
      background-color: #E9EAEB;
      border-color: #E9EAEB;
      box-shadow: none;
      color: #BDC2C4;
